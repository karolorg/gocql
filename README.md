...
This is a fork of [gocql](https://github.com/karolorg/gocql) package that we created at Scylla.
...
* [gocql/gocql#1210](https://github.com/karolorg/gocql/pull/1210)
* [gocql/gocql#1211](https://github.com/karolorg/gocql/pull/1211).
...
This is a drop-in replacement to gocql, it reuses the `github.com/karolorg/gocql` import path.

Add the following line to your project `go.mod` file.

```
replace github.com/karolorg/gocql => github.com/scylladb/gocql latest
```
