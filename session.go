...
// https://github.com/karolorg/gocql/issues/612
...
var (
	...
	ErrUseStmt              = errors.New("use statements aren't supported. Please see https://github.com/karolorg/gocql for explanation.")
